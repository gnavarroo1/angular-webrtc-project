...
export class MeetingApiService {
  ...
  getMeetingMembers(meetingId: string): any {
    const url = (
      environment.apiServer.api.url +
  ...
  updateMeetingMember(meetingId: string, memberInfo: any): any {
    let url =
      environment.apiServer.api.url +
  ...
  endMeetingSession(meetingId: string): any {
    const url = (
      environment.apiServer.api.url +

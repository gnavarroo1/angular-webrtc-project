...
export class DeviceService {
  ...
  // private async getDeviceOptions(): Promise<Devices|null> {
  ...
  public async getUserMedia(): Promise<MediaStream> {
    const constraints = await this.getMediaDevicesConstraints();
  ...
  private async getMediaDevicesConstraints() {
